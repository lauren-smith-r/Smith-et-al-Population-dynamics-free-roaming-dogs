...
time_dmat_italy <- time_dmat_italy <- matrix(c(
  # P=1,
  0, 3, 6, 12, 15,
  # P=2,
  3, 0, 3, 9, 12,
...
ps_simple <- read.csv("lauren-mcmc-samples-simple-19-12-2019.csv")
...
#Superpopulation
mean(ps_simple$superpop_italy.4)
HDI(ps_simple$superpop_italy.4)

#N_hat
mean(ps_simple$N_hat_italy.5.4)
HDI(ps_simple$N_hat_italy.5.4)

# Between country comparisons
mean( ps_simple$mu_lodd_phi_italy - ps_simple$mu_lodd_phi_ukr )
HDI( ps_simple$mu_lodd_phi_italy - ps_simple$mu_lodd_phi_ukr )
mean( (inv_logit(ps_simple$mu_lodd_phi_italy)) - (inv_logit(ps_simple$mu_lodd_phi_ukr)))
HDI( (inv_logit(ps_simple$mu_lodd_phi_italy)) - (inv_logit(ps_simple$mu_lodd_phi_ukr)))
mean(exp ( (ps_simple$mu_lodd_delta_italy) - ((ps_simple$mu_lodd_delta_ukr))))
...
mean( ps_simple$sigma_dog_ukr.4.3 )
HDI( ps_simple$sigma_dog_ukr.4.3 )

###Explanatory variables ####
mean(ps_simple$sigma_dog_ukr.4.3)
HDI(ps_simple$sigma_dog_ukr.4.3)
# mean(inv_logit(ps_simple$sigma_dog_italy.1.2))
...
mean(inv_logit(ps_simple$mu_lodd_phi_italy + ps_simple$sigma_dog_italy.1.2))
...
mean(ps_simple$mu_lodd_phi_italy)
HDI(ps_simple$mu_lodd_phi_italy)

#Odds of female delta
mean(exp(ps_simple$mu_lodd_phi_italy))
HDI(exp(ps_simple$mu_lodd_phi_italy))

# probability of female delta
mean(inv_logit(ps_simple$mu_lodd_phi_italy))
HDI(inv_logit(ps_simple$mu_lodd_phi_italy))

# total log odds of males' delta
mean(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2)
HDI(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2)
# Odds
mean(exp(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2))
HDI(exp(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2))
# probability of male delta
mean(inv_logit(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2))
HDI(inv_logit(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2))

# difference between males and females delta
mean(ps_simple$mu_lodd_phi_italy) - mean(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2)
mean(
  inv_logit(ps_simple$mu_lodd_phi_italy) - inv_logit(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2)
) 
HDI(
  inv_logit(ps_simple$mu_lodd_phi_italy) - inv_logit(ps_simple$mu_lodd_phi_italy + ps_simple$beta_sex_italy.2)
) 
